...
######      This will read in a master table file and calculate the allele frequency for SNP. For a given set of columns, we add up how many are hetero, how many are homo (inbred) and report the frequency. 
	#   Chrom position homo freq   heterofreq
#	USAGE:		 python /users/rreid2/scripts/python/rogers-allelefrequency.py ./pos-orange-col.txt
...
outfile.write("all-freq\tnumerator/denominator\t#ofHaptypes\n")
...
while 1:
	...
	outfile.write("%i/%i\t%i\n"% (numerator,denominator,numhaptypes))
