...
######      This will read in a VCF file and a Master file. 
	...
	#	USAGE:		 python ~/scripts/python/makeMasterSNPFile.py  /scratch/rreid2/banana/align/run3/someVCFFile.vcf snpmaster.txt 
