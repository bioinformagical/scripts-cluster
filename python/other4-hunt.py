...
######      This will read in a table and check 4 varieties ( NOT Calcuta4, Borneo,or  Guyod) are heterozygous at a position. . 
	#	USAGE:		 python ~/scripts/python/other4-hunt.py /nobackup/banana_genome/indieVCF/just7-14/other4-master.txt 
...
while 1:
	...
	linearray = line.split()
        sum=int(int(linearray[1]) + int(linearray[2]) + int(linearray[3]) + int(linearray[4]))
	if (sum > 0):
