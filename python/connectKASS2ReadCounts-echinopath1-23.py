...
######      This will read in 3 files
	...
	#
	#	USAGE:    python /home/rreid2/scripts/python/connectKASS2ReadCounts-echinopath1-23.py ./${num}.logfile.txt ../4db2/readcount/readspercontig-bj${num}.txt ./kaas/bj${num}-kaas.txt-justK.txt ${num}
	#
Prefix = ""
print sys.argv[1]
