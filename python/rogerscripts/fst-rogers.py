...
with open(sys.argv[1]) as afile:
	for line in afile:
		...
		if pattern.match(line):
			...
			numercontrol=numer1   # +numer2+numer3
			denomcontrol=denom1   # +denom2+denom3

			#Fst= [25/125*(1-25/125) - 50/125*(10/50)*(1-10/50) - 75/125*15/75*(1-15/75)] / [25/125*(1-25/125)]
			N=denomcontrol + denomdsant
			bothnumer=numercontrol + numerdsant

			top1=(bothnumer/N)*(1-(bothnumer/N))
			top2=-1
			if denomcontrol > 0:
				top2=(denomcontrol/N)*(numercontrol/denomcontrol)*(1-(numercontrol/denomcontrol))
			top3=(denomdsant/N)*(numerdsant/denomdsant)*(1-(numerdsant/denomdsant))
			top = top1-top2-top3
