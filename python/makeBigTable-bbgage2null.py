...
######      This will read in 2 files,  a master table and a new table that will become a new column in the table
	...
	#	USAGE:		 python /home/rreid2/scripts/python/makeBigTable-echinopathway2.py  ./all5-null-stats.txt  ./null2pad
Prefix = ""
print sys.argv[1]
...
file1 = open(sys.argv[2]+".stat.txt")
print sys.argv[2]
keggdict = {}
descdict = {}
while 1:
	...
	keggid=linearray[0]
	stat=linearray[1]
	k = keggid.split()[0].strip()	
	keggdict[k] =stat
	descdict[k] = keggid 
	print "KEGG ID = ",k,"\t and stat value = ",stat
...
while 1:
	...
	if k in keggdict.keys():
		outfile.write(keggdict[k])
	else:
		#outfile.write("0")	
