...
######      This will read in 4 files
	...
	#
	#	USAGE:    python /home/rreid2/scripts/python/connectKASS-FPKM--echino-24-48.py ./${num}.logfile.txt ../4db2/readcount/readspercontig-bj${num}.txt ./kaas/bj${num}-kaas.txt-justK.txt ./../4db2/wherebverNTFastaFileIs.fasta ${num}
	#
Prefix = ""
print sys.argv[1]
...
print "Done loading in Fasta file ansd converting it to fastadict with a size of ",len(fastadict)
