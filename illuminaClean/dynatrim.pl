...
print STDOUT "Info: You are using a modified version of Cox et al. ( BMC Bioinformatics, 2010, 11:485) DynamicTrim.pl\n";
...
foreach my $input_file ( @files ){
	...
	while( <INPUT> ){
		...
		##BiSD added the following line:
		if($seq_string !~ m/AGATCGGAAGAGCGGTTCAGCAG/ and length $seq_string >= 25)
		{
