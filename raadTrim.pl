...
foreach my $input_file ( @files ){
	...
	my $output_file = $filename . ".trimmed" . $phrd_cutoff;
	...
	while( <INPUT> ){
		...
		# remove all bases not part of the best segment from the beginning of the sequence and quality 
arrays
		...
		# if the "best" segment has a length of 0, set sequence to a single 'N' and quality score to a 
single 'B'
