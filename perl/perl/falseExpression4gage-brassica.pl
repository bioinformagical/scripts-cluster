...
# 	Iterate through the read count  table, swapping out the contig ID for the new Refseq Id. (track how many times we fail to find a match and send that to a "unique file"
#	Write a new FPKM table using the refseq Ids instead BUT THIS time we make N=3 and a fake control group  1	1	1
#	table will look like:
# 	XP88836363	FPKM	FPKM+1	FPKM+1	0	0	0
