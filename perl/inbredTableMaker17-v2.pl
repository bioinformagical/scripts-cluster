...
my $vcffile= "/nobackup/rogers_research/rob/gatk/nick-gatk/vcfFiles/readgrouped-".$ARGV[0].".raw.vcf" or die "VCF FILE OPEN \n I need a VCF file..s. \n";
my $hapfile= "/nobackup/rogers_research/Nick_DsantSequences/ControlFinal/".$ARGV[0]."_haps.txt" or die "Feed me hap file ...";
