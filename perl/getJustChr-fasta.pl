...
# This reads in a fasta file  and makes   new fasta file, keeping only the headers that have "chr" in the header...
#
#
...
open(OUTFILE, ">$fastafile-justchr.fasta") or die "can't write outfile";
